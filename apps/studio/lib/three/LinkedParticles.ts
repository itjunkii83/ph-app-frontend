...
export class LinkedParticles implements IAnimatedElement {
	...
	constructor(scene: Scene, camera: PerspectiveCamera, renderer: WebGPURenderer, post: PostProcessing) {

		Object.assign(this, { scene, camera, renderer, post });
