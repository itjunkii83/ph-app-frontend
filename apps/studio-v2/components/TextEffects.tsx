...
function EffectEditor({ initial, onClose }: { initial: TextEffect; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div className="grid h-full min-h-0 grid-cols-[1.5fr_1fr_0.75fr] gap-7">
        {/* Preview: the star of the layout. The stage fills the column width. */}
        <div className="flex min-h-0 flex-col">
          <div className="relative aspect-video w-full flex-none overflow-hidden rounded-xl border border-line bg-black">
          ...
          <div className="mb-3 mt-3 flex flex-none items-center gap-2">
            ...
            <Button onClick={() => setPlayKey((k) => k + 1)} className="ml-auto"><Play className="h-4 w-4" /> Replay effect</Button>
          </div>
        ...
        {/* Settings: the config panel owns the full modal height. */}
        <div className="min-h-0 overflow-y-auto rounded-xl border border-line bg-panel p-4">
        ...
        {/* Curation meta: short-form fields, narrow column, scrolls independently. */}
